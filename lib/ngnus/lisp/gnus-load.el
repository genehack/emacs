...
(put 'gnus-article-emphasis 'custom-loads '(assistant gnus-art))
...
(put 'extensions 'custom-loads '(sha1))
...
(put 'news 'custom-loads '(binhex canlock gnus message mm-decode spam spam-report uudecode))
(put 'gnus 'custom-loads '(auth-source gnus gnus-art gnus-async gnus-bookmark gnus-delay gnus-demon gnus-diary gnus-dup gnus-eform gnus-uu deuglify gnus-sieve gnus-soup gnus-undo gnus-win gnus-xmas mail-source mm-url nnimap nnmail nnmairix nntp spam-stat))
...
(put 'multimedia 'custom-loads '(gnus-audio mm-decode))
...
(put 'comm 'custom-loads '(dig dns-mode netrc tls))
...
(put 'mime-security 'custom-loads '(gnus-art mm-decode mml-smime mml2015))
...
(put 'applications 'custom-loads '(encrypt))
(put 'lisp 'custom-loads '(gmm-utils))
...
(put 'message 'custom-loads '(message mml mml-sec))
...
(put 'mail 'custom-loads '(binhex ecomplete gnus gnus-dired hashcash imap message mm-decode pop3 sieve-manage spam spam-report starttls uudecode))
...
(custom-put-if-not 'spam 'custom-version "22.1")
(custom-put-if-not 'spam 'group-documentation "Spam configuration.")
...
(custom-put-if-not 'gnus-bookmark-menu-heading 'custom-version "23.1")
(custom-put-if-not 'gnus-bookmark-menu-heading 'group-documentation nil)
...
(custom-put-if-not 'mm-uu-extract 'custom-version "23.1")
(custom-put-if-not 'mm-uu-extract 'group-documentation nil)
...
\(fn FILE &optional MODEL ERASE)" t nil)
...
;;;***

;;;### (autoloads nil nil ("auth-source.el" "compface.el" "cus-load.el"
;;;;;;  "dgnushack.el" "dig.el" "dns.el" "format-spec.el" "gnus-async.el"
;;;;;;  "gnus-bcklg.el" "gnus-cite.el" "gnus-cus.el" "gnus-demon.el"
;;;;;;  "gnus-dup.el" "gnus-eform.el" "gnus-ems.el" "gnus-int.el"
;;;;;;  "gnus-logic.el" "gnus-mh.el" "gnus-salt.el" "gnus-score.el"
;;;;;;  "gnus-setup.el" "gnus-srvr.el" "gnus-sum.el" "gnus-topic.el"
;;;;;;  "gnus-undo.el" "gnus-util.el" "gnus-uu.el" "gnus-vm.el" "gnus-xmas.el"
;;;;;;  "hex-util.el" "hmac-def.el" "hmac-md5.el" "ietf-drums.el"
;;;;;;  "imap.el" "legacy-gnus-agent.el" "lpath.el" "mail-parse.el"
;;;;;;  "mail-prsvr.el" "mail-source.el" "mailcap.el" "md4.el" "messagexmas.el"
;;;;;;  "messcompat.el" "mm-bodies.el" "mm-decode.el" "mm-encode.el"
;;;;;;  "mm-util.el" "mm-view.el" "mml-sec.el" "mml-smime.el" "mml.el"
;;;;;;  "netrc.el" "nnagent.el" "nnbabyl.el" "nndb.el" "nndir.el"
;;;;;;  "nndraft.el" "nneething.el" "nngateway.el" "nnheader.el"
;;;;;;  "nnheaderxm.el" "nnimap.el" "nnlistserv.el" "nnmail.el" "nnmaildir.el"
;;;;;;  "nnmairix.el" "nnmbox.el" "nnmh.el" "nnnil.el" "nnoo.el"
;;;;;;  "nnrss.el" "nnslashdot.el" "nnspool.el" "nntp.el" "nnultimate.el"
;;;;;;  "nnvirtual.el" "nnwarchive.el" "nnweb.el" "nnwfm.el" "ntlm.el"
;;;;;;  "password-cache.el" "pgg-def.el" "pgg-parse.el" "pgg-pgp.el"
;;;;;;  "pgg-pgp5.el" "pop3.el" "rfc1843.el" "rfc2045.el" "rfc2047.el"
